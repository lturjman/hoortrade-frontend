...
export default function productsList() {
  ...
  return (
    <div className="p-4 space-y-6 mt-4">
      {products.length === 0 ? (
        <div className="flex flex-col items-center justify-center w-full px-6 space-y-8 ">
        ...
        <div className="w-full max-w-5xl mx-auto px-4">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link
              href="/products/new"
              className="aspect-square hidden sm:flex h-full w-full min-h-4xl cursor-pointer transition-transform hover:scale-105 duration-300 ease-in-out flex-col items-center justify-center border-2 border-dashed backdrop-blur-md rounded-lg hover:text-cyan-500 hover:border-cyan-500 p-6 shadow-inner"
            >
              <PlusIcon className="w-10 h-10" />
