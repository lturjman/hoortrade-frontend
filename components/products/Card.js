...
export default function ProductCard({ product }) {
  return (
    <div className=" sm:aspect-square w-full mx-auto bg-white rounded-lg shadow-md overflow-hidden flex flex-col transition-transform hover:scale-[1.02] duration-200 dark:bg-zinc-600">
